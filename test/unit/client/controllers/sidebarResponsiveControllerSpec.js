...
describe('Sidebar Responsive Controller', function() {
    ...
    beforeEach(inject(function($injector, $controller,
        ...
        $scope = $rootScope.$new();
        SidebarResponsiveCtrl = $controller('SidebarResponsiveCtrl', {
            $scope: $scope,
            $rootScope: $rootScope,
    ...
    it('should get the current section and the responsive data', function() {
        expect($scope.sidebarResp.sectionsData).toEqual(mockedData.sidebarMockedData.sectionsData);
    ...
    it('should be listening when the sidebar responsive has been toggled', function() {
        var toggleResponsiveSidebar = true;
        $rootScope.$broadcast(mockedData.responsiveMockedData.subscriptionTogglingSidebar, toggleResponsiveSidebar);
        expect($rootScope.$broadcast).toHaveBeenCalledWith(
                             mockedData.responsiveMockedData.subscriptionTogglingSidebar,
                             toggleResponsiveSidebar);
        expect($scope.responsiveData.showResponsiveMenu).toBe(toggleResponsiveSidebar);
    });
